...
Repositories on GitHub:
    ...
    - Community: GitHub has a large and active community of developers who contribute to open-source projects, share knowledge, and provide support to others.
    ...
    - Review and discuss changes before merging: Pull requests allow developers to propose changes to the codebase and receive feedback from others before merging them. This helps to ensure that the code is of high quality and meets the project's standards.
...
Version Control with Git:
    ...
    3. Name your repository: Enter a name for your repository. 
...
Pull Requests and Code Reviews:
    ...
    7. Navigate to the "Pull requests" tab in your repository.
    8. Click on "New pull request".
    9. Select the base branch (usually the main branch) and the head branch (your new branch).
    10. Enter a title and description for your pull request.
    11. Click on "Create pull request".
    12. Review the changes and discuss them with other team members.
    13. Once the changes are approved, merge the pull request into the main branch.
